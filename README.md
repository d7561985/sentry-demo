...
- Версия проекта хранится в файле `.version` (текущая: 1.0.29)
...
- Включают ассоциацию с git коммитами (если доступен git)
- Source maps привязываются к конкретному релизу
- В Sentry Dashboard можно видеть:
  - Какие ошибки появились в новом релизе
  - Сравнение производительности между релизами
  - Какие коммиты вошли в релиз
