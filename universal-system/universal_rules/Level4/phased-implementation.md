...
rule: phased-implementation
type: level
description: This document outlines a structured phased implementation approach for
  Level 4 (Complex System) tasks, ensuring controlled, incremental delivery of complex
  systems with appropriate verification at each phase.
version: '1.0'
created: '2025-06-28'
modified: '2025-06-28'
dependencies:
