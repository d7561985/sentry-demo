...
rule: workflow-level4
type: level
description: This document outlines a comprehensive workflow for Level 4 (Complex
  System) tasks, including 7 key phases with rigorous planning, mandatory creative
  phases, architectural design, phased implementation, and extensive documentation.
version: '1.0'
created: '2025-06-28'
modified: '2025-06-28'
dependencies:
