...
rule: planning-comprehensive
type: level
description: This document provides structured planning guidelines for Level 3 (Intermediate
  Feature) tasks, focusing on comprehensive planning with creative phases and clear
