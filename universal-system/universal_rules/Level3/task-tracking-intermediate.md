...
rule: task-tracking-intermediate
type: level
description: This document provides structured task tracking guidelines for Level
  3 (Intermediate Feature) tasks, using visual tracking elements and clear checkpoints.
version: '1.0'
created: '2025-06-28'
modified: '2025-06-28'
dependencies:
