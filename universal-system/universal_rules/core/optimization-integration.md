...
rule: optimization-integration
type: core
description: This file serves as the integration point for all Memory Bank optimizations,
  coordinating the various optimization components to work seamlessly together.
version: '1.0'
created: '2025-06-28'
modified: '2025-06-28'
dependencies:
