...
rule: mode-transition-optimization
type: core
description: This file implements optimized mode transitions to preserve context efficiently
  between different phases of the Memory Bank system.
version: '1.0'
created: '2025-06-28'
modified: '2025-06-28'
dependencies:
