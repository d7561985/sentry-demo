...
rule: main-optimized
type: core
description: This system uses optimized context management and adaptive rule loading
  to maximize token efficiency while preserving the structured development approach.
version: '1.0'
created: '2025-06-28'
modified: '2025-06-28'
dependencies:
