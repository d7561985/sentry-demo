...
rule: van-complexity-determination
type: visual-map
description: This component determines the appropriate complexity level (1-4) for
  the current task and directs the workflow accordingly.
version: '1.0'
created: '2025-06-28'
modified: '2025-06-28'
dependencies:
