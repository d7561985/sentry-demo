...
rule: van-mode-map
type: visual-map
description: This visual map defines the VAN mode process for project initialization,
  task analysis, and technical validation. It guides users through platform detection,
  file verification, complexity determination, and technical validation to ensure
  proper setup before implementation.
version: '1.0'
created: '2025-06-28'
modified: '2025-06-28'
dependencies:
