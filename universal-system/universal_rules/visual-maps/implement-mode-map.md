...
rule: implement-mode-map
type: visual-map
description: This visual map guides the BUILD mode process, focusing on efficient
  code implementation based on the planning and creative phases, with proper command
