...
rule: creative-mode-map
type: visual-map
description: This visual map guides the CREATIVE mode process, focusing on structured
  design decision-making for components that require deeper exploration before implementation.
version: '1.0'
created: '2025-06-28'
modified: '2025-06-28'
dependencies:
