...
rule: optimized-workflow-level1
type: level
description: This streamlined workflow for Level 1 tasks (quick bug fixes) optimizes
  for speed and token efficiency while maintaining quality.
version: '1.0'
created: '2025-06-28'
modified: '2025-06-28'
dependencies:
